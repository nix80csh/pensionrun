...
public class Coolsms extends Https {
	...
	public static final String smsApi_key = "NCS55277D32B2001";
	public static final String smsApi_secret = "9FAEBDB4D7795C726F3F7BAF5D8D81C4";
	...
	public Coolsms() {
		...
		this.api_key = smsApi_key;
		this.api_secret = smsApi_secret;
	}
